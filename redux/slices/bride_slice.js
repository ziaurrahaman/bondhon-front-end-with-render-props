...
export const brideGroomSlice = createSlice({
  ...
  reducers: {
    SetBrideRegPayloadAction: (state, action) => {
      ...
      // (state.dataAlready_given = action.payload.dataAlready_given),
      // (state.method_of_kazi = action.payload.method_of_kazi),
      // (state.id_for_update_citizen = action.payload.id_for_update_citizen),
      // state.id_for_update_present_address = action.payload;
