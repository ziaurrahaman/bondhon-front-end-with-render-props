...
import {
  getGroomInforamtion,
  getMarriageInfoReportUrl,
  BrideOrGroomAllInfoGetUrl,
} from "../../../url/ApiList";
...
import MarriageInfoDetails from "../marriageInfo/MarriageInofDtl";
...
const MarriageReport = () => {
  ...
  const columns = [
    { id: "groom_name", label: "বরের নাম" },
    {
      id: "groom_id",
      label: "বরের জন্ম নিবন্ধন / জাতীয় পরিচয়পত্র নাম্বার",
    },
    { id: "groom_dob", label: "বরের জন্ম তারিখ" },
    { id: "bride_name", label: "কনের নাম" },
    {
      id: "bride_id",
      label: "কনের জন্ম নিবন্ধন / জাতীয় পরিচয়পত্র নাম্বার",
    },
    { id: "bride_dob", label: "কনের জন্ম তারিখ" },
    { id: "nikahnama_no", label: "নিকাহনামা নম্বর" },
    { id: "sonod_no", label: "সনদপত্র নাম্বার" },
  ];
  ...
  async function createRowsForGroom() {
    const result = await axios.get(getMarriageInfoReportUrl);
  ...
  const requestSearch = (e) => {
    ...
    const filteredRows = groomRows.filter((row) => {
      return (
        row.nikahnama_no.toLowerCase().includes(data.toLowerCase()) ||
        row.sonod_no.toLowerCase().includes(data.toLowerCase())
      );
    });
      ...
      >
        <Container>
                            ...
                            <TableCell align="center">
                              <a href="#">
                                <VisibilityIcon
                                  color="primary"
                                  onClick={() =>
                                    handleOpenGroomData(row.nikahnama_no)
                                  }
                                />
                              </a>
                            </TableCell>
          ...
          >
            <Fade in={open}>
              <Box sx={style}>
                <MarriageInfoDetails nikahnamaNo={docNo} />
              </Box>
            </Fade>
          </Modal>
        </Container>
