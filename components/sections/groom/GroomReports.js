...
import { getGroomInforamtion } from "../../../url/ApiList";
...
const GroomReport = () => {
  ...
  const columns = [
    { id: "citizen_name", label: "বরের নাম" },
  ...
  async function createRowsForGroom() {
    const result = await axios.get(getGroomInforamtion);
